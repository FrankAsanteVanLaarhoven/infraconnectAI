...
export default function LiveDemoConsole() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-green-400 p-8 font-mono flex items-center justify-center">
      <div className="w-full max-w-5xl border border-slate-800 bg-black shadow-[0_0_40px_rgba(34,197,94,0.15)] rounded-lg overflow-hidden flex flex-col">
        ...
        <div className="bg-[#111] border-b border-slate-800 px-4 py-2 flex items-center justify-between">
          ...
          <div className="flex gap-2 items-center">
            ...
            <span className="text-[9px] text-green-500 uppercase">Live (mTLS Tunnel)</span>
          </div>
        </div>
        ...
        <div className="p-6 flex-1 min-h-[400px]">
          <div className="flex gap-3 items-center mb-4 text-slate-400 text-sm">
            <span className="text-green-500">root@grok-edge-node:~#</span>
            <span className="text-purple-400">./gdsc run --query</span>
          </div>
          ...
          <div className="mb-8 flex items-center gap-2 pl-4 border-l-2 border-slate-800">
             ...
             {step === 0 && <span className="w-2 h-4 bg-green-400 animate-pulse inline-block" />}
          </div>
                ...
                <table className="w-full text-left text-sm border-collapse">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-800/50 hover:bg-slate-900 transition-colors text-slate-300">
                      <td className="py-3 px-4 font-mono text-purple-400">5</td>
