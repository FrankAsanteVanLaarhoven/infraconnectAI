    ...
    <div className="flex flex-col gap-3">
       ...
       <div className="flex items-center justify-between px-2">
          <div className="flex items-center gap-3">
             <Video className={cn("w-3 h-3 transition-colors", status === 'RECORDING' ? "text-red-500 " : "text-slate-600")} />
       ...
       <GlassCard className={cn(
         ...
         status === 'RECORDING' && "border-red-900/40 "
       )}>
          <div className="flex items-center justify-between gap-4">
             ...
             <button 
               ...
               className={cn(
                 "flex-1 group flex items-center justify-center gap-3 h-10 rounded-sm border transition-all relative overflow-hidden",
                 status === 'RECORDING' 
             ...
             >
                {status === 'RECORDING' ? (
                  ...
                  <>
                    <Circle className="w-3.5 h-3.5 fill-current group-active:scale-90 transition-transform" />
             ...
             <button 
               ...
               className={cn(
                 "w-12 h-10 flex items-center justify-center rounded-sm border transition-all",
                 status !== 'IDLE' 
             ...
             <button 
               ...
               className="w-10 h-10 flex items-center justify-center rounded-sm border border-white/5 bg-slate-900/40 text-slate-500 hover:text-amber-500 hover:border-amber-500/30 transition-all group"
               title="Frame Capture"
             >
             ...
             <button 
               ...
               className={cn(
                 "w-10 h-10 flex items-center justify-center rounded-sm border transition-all group",
                 isPresenterActive 
             ...
             >
                <User className={cn("w-3.5 h-3.5 transition-transform group-active:scale-90", isPresenterActive && "")} />
             </button>
          ...
          <div className="mt-4 pt-3 border-t border-white/5 flex justify-between items-center">
             <div className="flex items-center gap-2">
                <div className={cn("w-1 h-1 rounded-sm", status === 'RECORDING' ? "bg-red-500 animate-ping" : "bg-slate-800")} />
