// src/lib/hooks/useCognitiveCore.ts

import { useState, useEffect, useCallback } from 'react'
import type { PersonaListProjection, PersonaProfileProjection } from '@/lib/projections/cognitive'

interface UseCognitiveCoreReturn {
...
export function useCognitiveCore(): UseCognitiveCoreReturn {
